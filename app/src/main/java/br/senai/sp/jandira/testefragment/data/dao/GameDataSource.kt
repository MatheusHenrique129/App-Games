    ...
    companion object{
        fun getGames(context: Context) : ArrayList<Game> {
            ...
            games.add(Game(
                ...
                4.5f,
                listOf(
                    Console(1, "PlayStation 3", "Sony", "2009-11-21","null", context.getDrawable(R.drawable.midnight)!!),
                    Console(2, "Xbox 360", "Microsoft", "2008-12-12","null", context.getDrawable(R.drawable.midnight)!!)
                ))
            )
